...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║                      BIO_GROWTH TASK GENERATION SCRIPT                        ║
║                                                                               ║
║  Generates plant growth stage prediction tasks.                               ║
║  Each task shows a plant at one stage and asks to predict the next stage.     ║
╚══════════════════════════════════════════════════════════════════════════════╝
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate plant growth stage prediction dataset",
...
Examples:
    ...
    print(f"🌱 Generating {args.num_samples} plant growth tasks...")
    ...
    print(f"✅ Done! Generated {len(tasks)} plant growth tasks in {args.output}/{config.domain}_task/")
